...
const HOVER_HEX_STYLEBOX := preload("res://scenes/card_ui/card_ui_hover_hex.tres")
...
func _on_visuals_mouse_entered() -> void:
    if card and card.type == Card.Type.HEX:
        card_frame.set("theme_override_styles/panel", HOVER_HEX_STYLEBOX)
...
func _on_visuals_mouse_exited() -> void:
    if card and card.type == Card.Type.HEX:
        card_frame.set("theme_override_styles/panel", HEX_STYLEBOX)
    elif card and card.can_play_without_dice:
...
func set_card(value: Card) -> void:
    ...
    # Hex first: junk is Celestial, so without this it falls into the Celestial branch
